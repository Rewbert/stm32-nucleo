...
The TCB of MicroHasTEE is made up of the peripheral drivers, startup code, linker scripts, the MicroHs compiler, the MicroHs runtime system, and the MicroHs base libraries.
The size of the components is presented in ~\cref{table:tcb}.
...
\begin{table}[ht]
  ...
  \begin{tabular}{lr}
    ...
    MicroHs runtime system & TBD \\
    MicroHs base-library closure & 13258 \\
    \addlinespace
...
\todo{Need to explicitly say something about GCC. Why do I include MicroHs above, but not GCC?}
