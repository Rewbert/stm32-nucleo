...
The program's setup phase configures the attribution of tracked peripherals, GPIO pins, and interrupts, registers callbacks and Secure services, and starts the Non-secure application.
The fixed flash and SRAM partition has already been established by the linker scripts and Secure startup code.
...
The STM32U5A5ZJQ we use has 2.5 MiB of SRAM, well beneath our requirements.
...
The developer must still write the register-manipulating code that configures the SAY \& IDAU and attributes peripherals.
