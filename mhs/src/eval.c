...
void printTag(NODEPTR n) {
  switch(GETTAG(n)) {
  case T_B:   TRACE("B"); break;
  case T_O:   TRACE("O"); break;
  case T_K:   TRACE("K"); break;
  case T_CC:  TRACE("C'"); break;
  case T_C:   TRACE("C"); break;
  case T_A:   TRACE("A"); break;
  case T_SS:  TRACE("S'"); break;
  case T_FORPTR:
    if (n == comb_stdin)
      TRACE("IO.stdin");
      ...
      ERR("Cannot print foreign pointers");
    }
    break;
  case T_P:   TRACE("P"); break;
  case T_R:   TRACE("R"); break;
  case T_I:   TRACE("I"); break;
  case T_S:   TRACE("S"); break;
  case T_U:   TRACE("U"); break;
  case T_Y:   TRACE("Y"); break;
  case T_BB:  TRACE("B'"); break;
  case T_Z:   TRACE("Z"); break;
  case T_K2:  TRACE("K2"); break;
  case T_K3:  TRACE("K3"); break;
  case T_K4:  TRACE("K4"); break;
  case T_CCB: TRACE("C'B"); break;
  case T_AP:  TRACE("%p@%p", FUN(n), ARG(n)); break;
  case T_IND: TRACE("*"); break;
  case T_IO_THEN: TRACE("IO.>>"); break;
  case T_GE:   TRACE(">="); break;
  case T_LT:   TRACE("<"); break;
  case T_GT:   TRACE(">"); break;
  case T_LE:   TRACE("<="); break;
  case T_EQ:   TRACE("=="); break;
  case T_SEQ:  TRACE("seq"); break;
  case T_ADD:  TRACE("+"); break;
  case T_SUB:  TRACE("-"); break;
  case T_MUL:  TRACE("*"); break;
  case T_QUOT: TRACE("quot"); break;
  case T_REM:   TRACE("rem"); break;
  case T_UQUOT: TRACE("uquot"); break;
  case T_UREM:  TRACE("urem"); break;
  case T_SUBR:  TRACE("subtract"); break;
  case T_NEG:   TRACE("neg"); break;
  case T_AND:   TRACE("and"); break;
  case T_OR:    TRACE("or"); break;
  case T_XOR:   TRACE("xor"); break;
  case T_INV:   TRACE("inv"); break;
  case T_SHL:   TRACE("shl"); break;
  case T_SHR:   TRACE("shr"); break;
  case T_ASHR:  TRACE("ashr"); break;
  case T_FADD:  TRACE("f+"); break;
  case T_FSUB:  TRACE("f-"); break;
  case T_FMUL:  TRACE("f*"); break;
  case T_FDIV:  TRACE("f/"); break;
  case T_FNEG:  TRACE("fneg"); break;
  case T_ITOF:  TRACE("itof"); break;
  case T_FEQ:   TRACE("f=="); break;
  case T_FNE:   TRACE("f/="); break;
  case T_FLT:   TRACE("f<"); break;
  case T_FLE:   TRACE("f<="); break;
  case T_FGT:   TRACE("f>"); break;
  case T_FGE:   TRACE("f>="); break;
  case T_FSHOW: TRACE("fshow"); break;
  case T_FREAD: TRACE("fread"); break;
  case T_ULT:   TRACE("u<"); break;
  case T_ULE:   TRACE("u<="); break;
  case T_UGT:   TRACE("u>"); break;
  case T_UGE:   TRACE("u>="); break;
  case T_FPADD: TRACE("fp+"); break;
  case T_FP2P:  TRACE("fp2p"); break;
  case T_FPNEW: TRACE("fpnew"); break;
  case T_FPFIN: TRACE("fpfin"); break;
  case T_EQUAL: TRACE("equal"); break;
  case T_COMPARE: TRACE("compare/scmp"); break;
  case T_ICMP:    TRACE("icmp"); break;
  case T_UCMP:    TRACE("ucmp"); break;
  case T_RNF:     TRACE("rnf"); break;
  case T_BSFROMUTF8:  TRACE("fromUTF8"); break;
  case T_BSTOUTF8:    TRACE("toUTF8"); break;
  case T_BSHEADUTF8:  TRACE("HEADUtf8"); break;
  case T_BSAPPEND:    TRACE("bs++"); break;
  case T_BSAPPENDDOT: TRACE("bs++."); break;
  case T_BSAPPEND3: TRACE("bs+++"); break;
  case T_BSEQ:      TRACE("bs=="); break;
  case T_BSNE:      TRACE("bs/="); break;
  case T_BSLT:      TRACE("bs<"); break;
  case T_BSLE:      TRACE("bs<="); break;
  case T_BSGT:      TRACE("bs>"); break;
  case T_BSGE:      TRACE("bs>="); break;
  case T_BSCMP:     TRACE("bscmp"); break;
  case T_BSPACK:    TRACE("bspack"); break;
  case T_BSUNPACK:  TRACE("bsunpack"); break;
  case T_BSLENGTH:  TRACE("bslength"); break;
  case T_BSSUBSTR:  TRACE("bssunstr"); break;//   /* IO primops */  case T_IO_BIND: prinf("IO.>>=",); break;
  case T_IO_BIND:      TRACE("IO.>>="); break;
  case T_IO_RETURN:    TRACE("IO.return"); break;
  case T_IO_CCBIND:    TRACE("IO.C'BIND"); break;
  case T_IO_SERIALIZE: TRACE("IO.serialize"); break;
  case T_IO_PRINT: TRACE("IO.print"); break;
  case T_IO_DESERIALIZE: TRACE("IO.deserialize"); break;
  case T_IO_STDIN:  TRACE("IO.stdin"); break;
  case T_IO_STDOUT: TRACE("IO.stdout"); break;
  case T_IO_STDERR: TRACE("IO.stderr"); break;
  case T_IO_GETARGREF:    TRACE("IO.getArgRef"); break;
  case T_IO_GETTIMEMILLI: TRACE("IO.getTimeMilli"); break;
  case T_IO_PERFORMIO: TRACE("IO.performIO"); break;
  case T_IO_GC:        TRACE("IO.gc"); break;
  case T_RAISE:        TRACE("raise"); break;
  case T_CATCH:        TRACE("catch"); break;
  case T_ARR_ALLOC:    TRACE("A.alloc"); break;
  case T_ARR_COPY:  TRACE("A.copy"); break;
  case T_ARR_SIZE:  TRACE("A.size"); break;
  case T_ARR_READ:  TRACE("A.read"); break;
  case T_ARR_WRITE: TRACE("A.write"); break;
  case T_ARR_EQ:    TRACE("A.=="); break;
  case T_DYNSYM:    TRACE("dynsym"); break;
  case T_NEWCASTRINGLEN: TRACE("newCASttringLen"); break;
  case T_PEEKCASTRING:   TRACE("peektCAString"); break;
  case T_PEEKCASTRINGLEN: TRACE("peekCASttringLen"); break;
  case T_TOPTR: TRACE("toPtr"); break;
  case T_TOINT: TRACE("toInt"); break;
  case T_TODBL: TRACE("toDbl"); break;
  case T_TOFUNPTR: TRACE("ttoFunPtr"); break;
  case T_INT: TRACE("#%ld", GETVALUE(n)); break;
  case T_ARR: TRACE("<array>"); break;
  case T_PTR: TRACE("fp2p"); break;
  case T_BSTR:
    struct bytestring bs = BSTR(n);
  ...
  case T_IO_CCALL:
    TRACE("^");
    struct ffi_entry e = FFI_IX((int)GETVALUE(n));
    const char *name = e.ffi_name;
    TRACE("%s", name);
    break;
  default: TRACE("other %d", GETTAG(n)); break;
  }
}
...
#define GOIND(x) do { SETIND(n, (x)); printTag(n); TRACE(" stack size: %ld\n", stack_ptr - stk); goto ind; } while(0)
#define GOAP(f,a) do { FUN((n)) = (f); ARG((n)) = (a); printTag(n); TRACE(" stack size: %ld\n", stack_ptr - stk); goto ap; } while(0)
...
#define CMPP(op)       do { OPPTR2(r = xp op yp); GOIND(r ? combTrue : combFalse); } while(0)
 ...
 top:
  ...
  case T_FORPTR: RET;
  case T_ARR:  RET;
  case T_BADDYN: TRACE("FFI unknown %s\n", CSTR(n)); ERR1("FFI unknown %s", CSTR(n));
...
void mhs_from_NODEPTR(stackptr_t stk, int n, NODEPTR np)
{
  CHECKIO(n+1);
  TOP(0) = np;
}
...
MHS_TO(mhs_to_Bytestring, evalstring, struct bytestring);
//struct bytestring str = evalstring(ARG(TOP(0 + 2)));
...
void mhs_putb(int s) {
  //TRACE("going to eval the int\n");
  value_t i = mhs_to_Int(s, 0);
  //TRACE("going to eval the handle\n");
  void *p = mhs_to_Ptr(s, 1);
  //TRACE("actually printing the byte now\n");
  putb(i, p);
  if (i == 10) {
    putb(13, p); // 13 = '\r'
  }
  mhs_from_Unit(s, 2);
  TRACE("returning from ^putb\n");
}
//  putb(mhs_to_Int(s, 0), mhs_to_Ptr(s, 1)); mhs_from_Unit(s, 2); }
...
void mhs_read_errno(int s) {
  mhs_from_Int(s, 0, errno);
}

void mhs_open_socket(int s) {
  value_t d = mhs_to_Int(s, 0);  // domain
  value_t st = mhs_to_Int(s, 1); // stream type
  value_t p = mhs_to_Int(s, 2);  // protocol

  int sh = socket(d, st, p);

  mhs_from_Int(s, 3, sh);
};

void mhs_close(int s) {
  value_t fd = mhs_to_Int(s, 0);

  int err = close(fd);

  mhs_from_Int(s, 1, err);
}

void mhs_create_sockaddr_in(int s) {
  struct sockaddr_in *sockaddr = malloc(sizeof(struct sockaddr_in));
  memset(sockaddr, 0, sizeof(*sockaddr));
  mhs_from_Ptr(s, 0, (void *) sockaddr);
}

void mhs_free_sockaddr_in(int s) {
  struct sockaddr_in *sockaddr = (struct sockaddr_in *)mhs_to_Ptr(s, 0);
  free(sockaddr);
  mhs_from_Unit(s, 1);
}

void mhs_set_sin_family(int s) {
  struct sockaddr_in *sockaddr = (struct sockaddr_in *) mhs_to_Ptr(s, 0);
  value_t d = mhs_to_Int(s, 1);

  sockaddr->sin_family = d;

  mhs_from_Unit(s, 2);
}

void mhs_set_sin_port(int s) {
  struct sockaddr_in *sockaddr = (struct sockaddr_in *) mhs_to_Ptr(s, 0);
  value_t p = mhs_to_Int(s, 1);
...
void mhs_set_sin_addr(int s) {
  struct sockaddr_in *sockaddr = (struct sockaddr_in *) mhs_to_Ptr(s, 0);
  struct bytestring str = mhs_to_Bytestring(s, 1);
  char *st = (char *)str.string;

  int err = inet_pton(AF_INET, st, &sockaddr->sin_addr);

  mhs_from_Int(s, 2, err);
}

void mhs_set_sin_addr_any(int s) {
  struct sockaddr_in *sockaddr = (struct sockaddr_in *) mhs_to_Ptr(s, 0);
...
void mhs_connect(int s) {
  struct sockaddr_in *server_addr;

  value_t sockfd = mhs_to_Int(s, 0);
  server_addr = (struct sockaddr_in *)mhs_to_Ptr(s, 1);
...
void mhs_send(int s) {
  value_t sockfd = mhs_to_Int(s, 0);
  struct bytestring str = mhs_to_Bytestring(s, 1); // evalstring(ARG(TOP(1 + 2))); // the ip address, two cells are already reserved on stack
  char *st = (char *)str.string;

  int sent = send(sockfd, st, strlen(st), 0);

  mhs_from_Int(s, 2, sent);
}

void mhs_bind(int s) {
  value_t socket_fd = mhs_to_Int(s, 0);
  struct sockaddr_in *server_addr = (struct sockaddr_in*) mhs_to_Ptr(s, 1);
...
void mhs_listen(int s) {
  value_t server_fd = mhs_to_Int(s, 0);

  int err = listen(server_fd, 1);

  mhs_from_Int(s, 1, err);
}

void mhs_accept(int s) {
  value_t server_fd = mhs_to_Int(s, 0);
  struct sockaddr_in *client_addr = (struct sockaddr_in *)mhs_to_Ptr(s, 1);

  socklen_t client_len = sizeof(*client_addr);
  value_t client_fd = accept(server_fd, (struct sockaddr *)client_addr, &client_len);

  mhs_from_Int(s, 2, client_fd);
}

void mhs_recv(int s) {
  value_t client_fd = mhs_to_Int(s, 0);

  char buf[256];
  int buf_size = 256-1;
  int flags = 0;
  int bytes_received = recv(client_fd, buf, buf_size, flags);
  buf[bytes_received] = '\0';

  NODEPTR str = mkStringC(buf);
  mhs_from_NODEPTR(s, 1, str);
}


#endif /* WANT_SIMPLE_NETWORK */
...
#endif  /* WANT_DIR */
#if WANT_SIMPLE_NETWORK
{ "socket", mhs_open_socket},
{ "close", mhs_close },
{ "create_sockaddr_in", mhs_create_sockaddr_in },
{ "free_sockaddr_in", mhs_free_sockaddr_in },
{ "connect", mhs_connect },
{ "send", mhs_send },
{ "bind", mhs_bind },
{ "listen", mhs_listen },
{ "accept", mhs_accept },
{ "recv", mhs_recv },
{ "set_sin_family", mhs_set_sin_family },
{ "set_sin_port", mhs_set_sin_port },
{ "set_sin_addr", mhs_set_sin_addr },
{ "set_sin_addr_any", mhs_set_sin_addr_any },
{ "read_errno", mhs_read_errno },
#endif
{ 0,0 }
};
