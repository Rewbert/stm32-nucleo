...
static void stm32l5_timer_init(struct timer_dev *dev, timer_config_t *config) {
    stm32l5_timer_backend_t *backend = (stm32l5_timer_backend_t *) dev->backend;
...
static void stm32l5_timer_register_callback(struct timer_dev *dev, timer_callback_t cb) {
    (void)dev;
    tim6_callback = cb;
}

static void stm32l5_timer_start(struct timer_dev *dev, uint32_t ticks) {
    stm32l5_timer_backend_t *backend = (stm32l5_timer_backend_t *) dev->backend;
...
static void stm32l5_timer_stop(struct timer_dev *dev) {
    stm32l5_timer_backend_t *backend = (stm32l5_timer_backend_t *) dev->backend;
    backend->tim->CR1 &= ~TIM_CR1_CEN;
}

static int stm32l5_timer_irqn(struct timer_dev *dev) {
    (void)dev;
    return TIM6_IRQn;
}

static const timer_driver_api_t stm32l5_timer_api = {
    .init              = stm32l5_timer_init,
    .register_callback = stm32l5_timer_register_callback,
    .start             = stm32l5_timer_start,
    .stop              = stm32l5_timer_stop,
    .irqn              = stm32l5_timer_irqn,
};

void stm32l5_timer_create(timer_dev_t *dev, TIM_TypeDef *tim, stm32l5_timer_backend_t *backend_storage) {
    dev->api              = &stm32l5_timer_api;
